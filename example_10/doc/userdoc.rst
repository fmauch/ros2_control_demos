...
For *example_10*, the hardware interface plugin is implemented having only one interface.
...
1. To check that *RRBot* descriptions are working properly use following launch commands
   ...
   * Or you can simply open the configuration from ``description/rviz`` folder manually or directly by executing
   ...
   .. code-block:: shell
    ...
    rviz2 --display-config `ros2 pkg prefix ros2_control_demo_example_10`/share/ros2_control_demo_example_10/rviz/rrbot.rviz
...
5. If you get output from above you can send commands to *Forward Command Controller*, either:
   ...
   .. code-block:: shell
    ...
    ros2 launch ros2_control_demo_example_10 test_forward_position_controller.launch.py
...
6. Let's switch to a different controller, the ``Joint Trajectory Controller``.
   ...
   .. note::
     ...
     The parameters are already set in `rrbot_controllers.yaml <https://github.com/ros-controls/ros2_control_demos/tree/master/example_10/bringup/config/rrbot_controllers.yaml>`__
     but the controller was not loaded from the `launch file rrbot.launch.py <https://github.com/ros-controls/ros2_control_demos/tree/master/example_10/bringup/launch/rrbot.launch.py>`__ before.
   ...
   .. code-block:: shell
    ...
    ros2 launch ros2_control_demo_example_10 test_joint_trajectory_controller.launch.py

   You can adjust the goals in `rrbot_joint_trajectory_publisher <https://github.com/ros-controls/ros2_control_demos/tree/master/example_10/bringup/config/rrbot_joint_trajectory_publisher.yaml>`__.
...
* Test nodes goals configuration:
  ...
  + `rrbot_forward_position_publisher <https://github.com/ros-controls/ros2_control_demos/tree/master/example_10/bringup/config/rrbot_forward_position_publisher.yaml>`__
  + `rrbot_joint_trajectory_publisher <https://github.com/ros-controls/ros2_control_demos/tree/master/example_10/bringup/config/rrbot_joint_trajectory_publisher.yaml>`__
